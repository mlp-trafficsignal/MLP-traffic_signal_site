...
function placeholderThumb(className = "entry-thumb tone-0") {
  return `<div class="${className}"><i></i><i></i><i></i></div>`;
}
...
function home() {
  ...
  app.innerHTML = `
    <section class="hero">
      <div class="hero-copy">
        <p class="eyebrow">MLP Ch Archive</p>
        <h1>信号機と道路標識を、見やすく残す。</h1>
        <p>都道府県別、カテゴリ別、メーカー別に整理して、写真と解説をスマートに見られるサイトです。</p>
      </div>
...
function photoImage(photo) {
  ...
  return `<div class="photo-placeholder"><span>画像</span></div>`;
}
